...
export type RideQuery = { __typename?: 'Query', ride: { __typename?: 'Ride', id: string, nb_passenger: number, max_passenger: number, departure_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, arrival_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, driver_id: { __typename?: 'User', id: string }, passenger_rides?: Array<{ __typename?: 'PassengerRide', user_id: string, ride_id: string, status: string }> | null } };

export type RidesQueryVariables = Exact<{ [key: string]: never; }>;


export type RidesQuery = { __typename?: 'Query', rides: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_address: string, departure_at: any, departure_city: string, arrival_address: string, arrival_at: any, arrival_city: string, is_canceled: boolean, max_passenger: number, nb_passenger: number, driver_id: { __typename?: 'User', id: string, firstName: string, lastName: string }, departure_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, arrival_location: { __typename?: 'Point', type: string, coordinates: Array<number> } }> };
...
export type SearchRidesQuery = { __typename?: 'Query', searchRide: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_city: string, departure_at: any, arrival_city: string, arrival_at: any, departure_address: string, arrival_address: string, max_passenger: number, nb_passenger: number, is_canceled: boolean, passenger_status?: string | null, departure_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, arrival_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, driver_id: { __typename?: 'User', id: string, firstName: string, lastName: string, createdAt: any, role: string }, passenger_rides?: Array<{ __typename?: 'PassengerRide', ride_id: string, user_id: string, status: string }> | null }> };
