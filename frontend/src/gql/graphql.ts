...
export type DriverRidesQuery = { __typename?: 'Query', driverRides: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_address: string, departure_at: any, departure_city: string, departure_lat: number, departure_lng: number, arrival_address: string, arrival_at: any, arrival_city: string, arrival_lat: number, arrival_lng: number, is_canceled: boolean, max_passenger: number, nb_passenger: number, driver_id: { __typename?: 'User', id: string, firstName: string, lastName: string, createdAt: any, role: string } }> };

export type PassengerRideQueryVariables = Exact<{
  data: CreatePassengerRideInput;
}>;


export type PassengerRideQuery = { __typename?: 'Query', passengerRide: Array<{ __typename?: 'PassengerRide', user_id: string, ride_id: string, status: string }> };
...
export type PassengerRidesQuery = { __typename?: 'Query', passengerRides: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_address: string, departure_at: any, departure_city: string, departure_lat: number, departure_lng: number, arrival_address: string, arrival_at: any, arrival_city: string, arrival_lat: number, arrival_lng: number, is_canceled: boolean, max_passenger: number, nb_passenger: number, passenger_status?: string | null, driver_id: { __typename?: 'User', id: string, firstName: string, lastName: string, createdAt: any, role: string }, passenger_rides?: Array<{ __typename?: 'PassengerRide', user_id: string, ride_id: string, status: string }> | null }> };
...
export type RidesQuery = { __typename?: 'Query', rides: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_address: string, departure_at: any, departure_city: string, departure_lat: number, departure_lng: number, arrival_address: string, arrival_at: any, arrival_city: string, arrival_lat: number, arrival_lng: number, is_canceled: boolean, max_passenger: number, nb_passenger: number, driver_id: { __typename?: 'User', id: string, firstName: string, lastName: string } }> };
...
export const PassengerRideDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PassengerRide"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreatePassengerRideInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"passengerRide"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"ride_id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<PassengerRideQuery, PassengerRideQueryVariables>;
