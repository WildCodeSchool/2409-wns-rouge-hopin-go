...
export type SearchRidesQuery = { __typename?: 'Query', searchRide: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_city: string, departure_at: any, arrival_city: string, arrival_at: any, departure_address: string, arrival_address: string, max_passenger: number, nb_passenger: number, is_canceled: boolean, available_seats: number, current_user_passenger_status?: PassengerRideStatus | null, departure_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, arrival_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, driver_id: { __typename?: 'User', id: string, firstName: string, lastName: string, createdAt: any, role: string }, passenger_rides?: Array<{ __typename?: 'PassengerRide', ride_id: string, user_id: string, status: PassengerRideStatus }> | null }> };
