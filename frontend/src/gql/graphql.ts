...
export type DriverRidesQuery = { __typename?: 'Query', driverRides: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_address: string, departure_at: any, departure_city: string, arrival_address: string, arrival_at: any, arrival_city: string, is_canceled: boolean, max_passenger: number, nb_passenger: number, driver_id: { __typename?: 'User', id: string, firstName: string, lastName: string, createdAt: any, role: string } }> };
