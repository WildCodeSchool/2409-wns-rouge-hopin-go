...
export type CreateRideMutation = {
  ...
  createRide: {
    ...
    driver_id: { __typename?: "User"; id: string; email?: string | null };
  };
};
...
export type PassengerRideQuery = {
  __typename?: "Query";
  passengerRide: Array<{
    __typename?: "PassengerRide";
    user_id: string;
...
export type RideQuery = {
  ...
  ride: {
    ...
    nb_passenger: number;
    max_passenger: number;
    driver_id: { __typename?: "User"; id: string };
    passenger_rides?: Array<{
      __typename?: "PassengerRide";
      user_id: string;
      ride_id: string;
...
export const CreatePassengerRideDocument = {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreatePassengerRideInput" },
            },
          },
        },
      ],
  ...
  CreatePassengerRideMutation,
  CreatePassengerRideMutationVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "departure_lat" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "departure_lng" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "arrival_address" },
                ...
                { kind: "Field", name: { kind: "Name", value: "arrival_lat" } },
                { kind: "Field", name: { kind: "Name", value: "arrival_lng" } },
                { kind: "Field", name: { kind: "Name", value: "is_canceled" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "max_passenger" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "nb_passenger" },
                },
              ],
            },
          },
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "PassengerRide" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
...
} as unknown as DocumentNode<PassengerRideQuery, PassengerRideQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "passenger_status" },
                },
              ],
            },
          },
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "SearchRideInput" },
            },
          },
        },
      ],
