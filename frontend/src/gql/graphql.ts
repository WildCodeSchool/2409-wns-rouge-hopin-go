...
export type SearchRidesQuery = { __typename?: 'Query', searchRide: Array<{ __typename?: 'Ride', departure_city: string, departure_at: any, arrival_city: string, arrival_at: any, departure_address: string, arrival_address: string, departure_lng: number, departure_lat: number, arrival_lng: number, arrival_lat: number, max_passenger: number, is_canceled: boolean, driverId: { __typename?: 'User', id: string, firstName: string, lastName: string } }> };
