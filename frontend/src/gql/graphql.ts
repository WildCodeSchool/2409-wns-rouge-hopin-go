...
export type CreateRideMutation = { __typename?: 'Mutation', createRide: { __typename?: 'Ride', departure_city: string, arrival_city: string, departure_at: any, arrival_at: any, max_passenger: number, driver_id: { __typename?: 'User', id: string, email?: string | null } } };
