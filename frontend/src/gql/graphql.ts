...
export type CreatePassengerRideMutation = {
  __typename?: "Mutation";
  createPassengerRide: { __typename?: "PassengerRide"; user_id: string; ride_id: string };
};
...
export type CreateRideMutation = {
  ...
  createRide: {
    ...
    route_polyline5?: string | null;
    driver: { __typename?: "User"; id: string; email?: string | null };
  };
};
...
export type DriverRidesQuery = {
  ...
  driverRides: {
    ...
    rides: Array<{
      __typename?: "Ride";
      id: string;
      current_user_passenger_status?: PassengerRideStatus | null;
      created_at: any;
      departure_address: string;
      departure_at: any;
      departure_city: string;
      ...
      departure_location: { __typename?: "Point"; type: string; coordinates: Array<number> };
      arrival_location: { __typename?: "Point"; type: string; coordinates: Array<number> };
      passenger_rides?: Array<{
        __typename?: "PassengerRide";
        ride_id: string;
        user_id: string;
        status: PassengerRideStatus;
...
export type DriverSetPassengerRideStatusMutation = {
  __typename?: "Mutation";
  driverSetPassengerRideStatus: {
    __typename?: "PassengerRide";
    status: PassengerRideStatus;
    user: { __typename?: "User"; id: string };
    ride: { __typename?: "Ride"; id: string };
  };
};
...
export type PassengerRidesQuery = {
  __typename?: "Query";
  passengerRides: {
    __typename?: "PaginatedRides";
    totalCount: number;
...
export type PassengerWithdrawFromRideMutation = {
  __typename?: "Mutation";
  passengerWithdrawFromRide: { __typename?: "PassengerRide"; ride_id: string };
};
...
export type PassengersByRideQuery = {
  __typename?: "Query";
  passengersByRide: Array<{
    __typename?: "PassengerRide";
    status: PassengerRideStatus;
...
export type RideQuery = {
  ...
  ride: {
    ...
    departure_location: { __typename?: "Point"; type: string; coordinates: Array<number> };
    arrival_location: { __typename?: "Point"; type: string; coordinates: Array<number> };
    driver: { __typename?: "User"; id: string };
    passenger_rides?: Array<{
      __typename?: "PassengerRide";
      user_id: string;
      ride_id: string;
...
export type RidesQuery = {
  ...
  rides: Array<{
    ...
    duration_min?: number | null;
    route_polyline5?: string | null;
    driver: { __typename?: "User"; id: string; firstName: string; lastName: string };
    departure_location: { __typename?: "Point"; type: string; coordinates: Array<number> };
    arrival_location: { __typename?: "Point"; type: string; coordinates: Array<number> };
  }>;
};
...
export type SigninMutation = {
  __typename?: "Mutation";
  signin?: { __typename?: "User"; id: string; email?: string | null } | null;
};
...
export const CreatePassengerRideDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreatePassengerRide" },
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "CreatePassengerRideInput" } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "ride_id" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<CreatePassengerRideMutation, CreatePassengerRideMutationVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "RideCreateInput" } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "departure_city" } },
                { kind: "Field", name: { kind: "Name", value: "arrival_city" } },
                { kind: "Field", name: { kind: "Name", value: "departure_address" } },
                { kind: "Field", name: { kind: "Name", value: "arrival_address" } },
                { kind: "Field", name: { kind: "Name", value: "departure_at" } },
                { kind: "Field", name: { kind: "Name", value: "arrival_at" } },
                { kind: "Field", name: { kind: "Name", value: "max_passenger" } },
                { kind: "Field", name: { kind: "Name", value: "distance_km" } },
                { kind: "Field", name: { kind: "Name", value: "duration_min" } },
                { kind: "Field", name: { kind: "Name", value: "route_polyline5" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<DeleteMyAccountMutation, DeleteMyAccountMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DriverRides" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
                ...
                { kind: "Field", name: { kind: "Name", value: "totalCount" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "current_user_passenger_status" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "departure_location" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "arrival_location" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "type" } },
                      ...
                      { kind: "Field", name: { kind: "Name", value: "max_passenger" } },
                      { kind: "Field", name: { kind: "Name", value: "nb_passenger" } },
                      { kind: "Field", name: { kind: "Name", value: "available_seats" } },
                      { kind: "Field", name: { kind: "Name", value: "distance_km" } },
                      { kind: "Field", name: { kind: "Name", value: "duration_min" } },
                      { kind: "Field", name: { kind: "Name", value: "route_polyline5" } },
                      { kind: "Field", name: { kind: "Name", value: "total_route_price" } },
                      { kind: "Field", name: { kind: "Name", value: "price_per_passenger" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "passenger_rides" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "ride_id" } },
...
} as unknown as DocumentNode<DriverRidesQuery, DriverRidesQueryVariables>;
export const DriverSetPassengerRideStatusDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "DriverSetPassengerRideStatusInput" },
            },
          },
        },
      ],
  ...
  DriverSetPassengerRideStatusMutation,
  DriverSetPassengerRideStatusMutationVariables
>;
export const PassengerRidesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "PassengerRides" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "filter" } },
...
} as unknown as DocumentNode<PassengerRidesQuery, PassengerRidesQueryVariables>;
export const PassengerWithdrawFromRideDocument = {
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "ride_id" },
                value: { kind: "Variable", name: { kind: "Name", value: "id" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "Field", name: { kind: "Name", value: "ride_id" } }],
            },
          },
        ],
      },
  ...
  PassengerWithdrawFromRideMutation,
  PassengerWithdrawFromRideMutationVariables
>;
export const PassengersByRideDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "ride_id" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
          },
            ...
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "ride_id" },
                value: { kind: "Variable", name: { kind: "Name", value: "ride_id" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<PassengersByRideQuery, PassengersByRideQueryVariables>;
export const RideDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<RideQuery, RideQueryVariables>;
export const RidesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<RidesQuery, RidesQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "SearchRideInput" } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "searchRide" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "data" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "current_user_passenger_status" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<UpdateMyAccountMutation, UpdateMyAccountMutationVariables>;
