...
export type SearchRidesQuery = { __typename?: 'Query', searchRide: Array<{ __typename?: 'Ride', departure_city: string, departure_at: any, arrival_city: string }> };
