...
export type CreateRideMutation = { __typename?: 'Mutation', createRide: { __typename?: 'Ride', departure_city: string, arrival_city: string, departure_address: string, arrival_address: string, departure_at: any, arrival_at: any, max_passenger: number, driver: { __typename?: 'User', id: string, email?: string | null } } };
...
export type RideQuery = { __typename?: 'Query', ride: { __typename?: 'Ride', id: string, nb_passenger: number, max_passenger: number, departure_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, arrival_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, driver: { __typename?: 'User', id: string }, passenger_rides?: Array<{ __typename?: 'PassengerRide', user_id: string, ride_id: string, status: PassengerRideStatus }> | null } };

export type RidesQueryVariables = Exact<{ [key: string]: never; }>;


export type RidesQuery = { __typename?: 'Query', rides: Array<{ __typename?: 'Ride', id: string, created_at: any, departure_address: string, departure_at: any, departure_city: string, arrival_address: string, arrival_at: any, arrival_city: string, is_cancelled: boolean, max_passenger: number, nb_passenger: number, driver: { __typename?: 'User', id: string, firstName: string, lastName: string }, departure_location: { __typename?: 'Point', type: string, coordinates: Array<number> }, arrival_location: { __typename?: 'Point', type: string, coordinates: Array<number> } }> };
